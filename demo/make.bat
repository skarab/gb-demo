...
@echo building banks...
..\gbdk\bin\bankpack -ext=.rel -v -yt19 gameboy.o demo.o erase.o sega.o part1_music.o lines.o cube.o noise.o fire.o axelay.o sprites_physics.o squares_zoom.o squares_race.o ..\gbdk\hUGEBuild\build\hUGEDriver.obj.o
@echo linking...
..\gbdk\bin\lcc -Wl-yo16 -Wa-l -Wl-m -Wl-j -Wl-yt27 -Wl-ya4 -o demo.gb gameboy.rel demo.rel erase.rel sega.rel part1_music.rel lines.rel cube.rel noise.rel fire.rel axelay.rel sprites_physics.rel squares_zoom.rel squares_race.rel ..\gbdk\hUGEBuild\build\hUGEDriver.obj.rel
@echo cleaning...
del *.map
del *.rel
del *.asm
