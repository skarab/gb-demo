...
@echo linking...
..\gbdk\bin\lcc -Wl-yo32 -Wl-ya0 -Wa-l -Wl-m -Wl-j -Wl-yt25 -o demo.gb vgmplayer.rel sample.rel gameboy.rel demo.rel shake.rel erase.rel sega.rel lines.rel cube.rel fire.rel axelay.rel sprites_physics.rel squares_zoom.rel squares_race.rel rain.rel vbarrels.rel kiss.rel funky_girl.rel senses.rel logo.rel landscape.rel scroller.rel title.rel tunnel.rel cube_video.rel tunnel_video.rel
@echo inject music...
