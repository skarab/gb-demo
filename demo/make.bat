...
..\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wl-yt26 -c -o tunnel_video.o src\tunnel_video.c
@echo building banks...
..\gbdk\bin\bankpack -ext=.rel -v -yt19 vgmplayer.o sample.o gameboy.o demo.o shake.o erase.o sega.o lines.o cube.o fire.o axelay.o sprites_physics.o squares_zoom.o squares_race.o rain.o vbarrels.o kiss.o funky_girl.o senses.o logo.o landscape.o scroller.o title.o tunnel.o cube_video.o tunnel_video.o
@echo linking...
..\gbdk\bin\lcc -Wl-yo32 -Wl-ya1 -Wa-l -Wl-m -Wl-j -Wl-yt26 -o demo.gb vgmplayer.rel sample.rel gameboy.rel demo.rel shake.rel erase.rel sega.rel lines.rel cube.rel fire.rel axelay.rel sprites_physics.rel squares_zoom.rel squares_race.rel rain.rel vbarrels.rel kiss.rel funky_girl.rel senses.rel logo.rel landscape.rel scroller.rel title.rel tunnel.rel cube_video.rel tunnel_video.rel
@echo inject music...
