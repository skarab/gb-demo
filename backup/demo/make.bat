...
@echo building banks...
..\gbdk\bin\bankpack -ext=.rel -v -yt19 gameboy.o demo.o nintendo.o sega.o part1_music.o title.o lines.o cube.o noise.o fire.o blittest.o axelay.o sprites_physics.o squares_zoom.o ..\gbdk\hUGEBuild\build\hUGEDriver.obj.o
@echo linking...
..\gbdk\bin\lcc -Wl-yo16 -Wa-l -Wl-m -Wl-j -Wl-yt27 -Wl-ya4 -o demo.gb gameboy.rel demo.rel nintendo.rel sega.rel part1_music.rel title.rel lines.rel cube.rel noise.rel fire.rel blittest.rel axelay.rel sprites_physics.rel squares_zoom.rel ..\gbdk\hUGEBuild\build\hUGEDriver.obj.rel
